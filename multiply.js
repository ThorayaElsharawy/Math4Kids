...
function generateEquation() {
    ...
    let allAnswers = []
    let genNum1 = Math.floor(Math.random() * 10);
    let genNum2 = Math.floor(Math.random() * 10);
    let dummyAnswer1 = Math.floor(Math.random() * 60);
    let dummyAnswer2 = Math.floor(Math.random() * 60);
